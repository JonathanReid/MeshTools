...
namespace ClipperLib
{
  ...
  public struct IntPoint
  {
    ...
    public IntPoint(IntPoint pt)
    {
      this.X = pt.X; this.Y = pt.Y; this.Z = pt.Z;
		...
		public IntPoint(Single x, Single y)
    {
      this.X = x; this.Y = y;
    }
  ...
  public class MyIntersectNodeSort : IComparer<IntersectNode>
  {
    ...
    {
      cInt i = (int)node2.Pt.Y - (int)node1.Pt.Y;
      if (i > 0) return 1;
  ...
  {    
    ...
    //------------------------------------------------------------------------------
		...
		public void Swap(ref Single val1, ref Single val2)
    {
			Single tmp = val1;
      val1 = val2;
      val2 = tmp;
      ...
      if (UseFullRange)
        return ((pt.X == linePt1.X) && (pt.Y == linePt1.Y)) ||
          ...
          ((pt.Y > linePt1.Y) == (pt.Y < linePt2.Y)) &&
					 ((Int128.Int128Mul(((int)pt.X - (int)linePt1.X), ((int)linePt2.Y - (int)linePt1.Y)) ==
					  Int128.Int128Mul(((int)linePt2.X - (int)linePt1.X), ((int)pt.Y - (int)linePt1.Y)))));
      else
        return ((pt.X == linePt1.X) && (pt.Y == linePt1.Y)) ||
          ((pt.X == linePt2.X) && (pt.Y == linePt2.Y)) ||
          (((pt.X > linePt1.X) == (pt.X < linePt2.X)) &&
    ...
    {
        if (UseFullRange)
				return Int128.Int128Mul((int)e1.Delta.Y, (int)e2.Delta.X) ==
					Int128.Int128Mul((int)e1.Delta.X, (int)e2.Delta.Y);
    ...
    {
        if (UseFullRange)
				return Int128.Int128Mul((int)pt1.Y - (int)pt2.Y, (int)pt2.X - (int)pt3.X) ==
					Int128.Int128Mul((int)pt1.X - (int)pt2.X, (int)pt2.Y - (int)pt3.Y);
        else return
    ...
    {
        if (UseFullRange)
				return Int128.Int128Mul((int)pt1.Y - (int)pt2.Y, (int)pt3.X - (int)pt4.X) ==
					Int128.Int128Mul((int)pt1.X - (int)pt2.X, (int)pt3.Y - (int)pt4.Y);
        else return
  ...
  public class Clipper : ClipperBase
  {
      ...
      //------------------------------------------------------------------------------
		...
		private void InsertScanbeam(Single Y)
      {
        if( m_Scanbeam == null )
        {
      ...
      //------------------------------------------------------------------------------
		...
		private Single PopScanbeam()
      {
			Single Y = m_Scanbeam.Y;
      ...
      //------------------------------------------------------------------------------
		...
		private void InsertLocalMinimaIntoAEL(Single botY)
      {
      ...
      //------------------------------------------------------------------------------
		...
		private bool HorzSegmentsOverlap(Single seg1a, Single seg1b, Single seg2a, Single seg2b)
      {
  ...
  //assumes that e1 will be to the Right of e2 ABOVE the intersection
      ...
      //------------------------------------------------------------------------------
		...
		void GetHorzDirection(TEdge HorzEdge, out Direction Dir, out Single Left, out Single Right)
      {
      ...
      //------------------------------------------------------------------------------
		...
		private bool ProcessIntersections(Single topY)
      {
      ...
      //------------------------------------------------------------------------------
		...
		private void BuildIntersectList(Single topY)
      {
      ...
      //------------------------------------------------------------------------------
		...
		private static Single TopX(TEdge edge, Single currentY)
      {
      ...
      //------------------------------------------------------------------------------
		...
		private void ProcessEdgesAtTopOfScanbeam(Single topY)
      {
        TEdge e = m_ActiveEdges;
        while(e != null)
        {
      ...
      //------------------------------------------------------------------------------
		...
		bool GetOverlap(Single a1, Single a2, Single b1, Single b2, out Single Left, out Single Right)
      {
        if (a1 < a2)
        {
      ...
      private static int PointInPolygon(IntPoint pt, OutPt op)
      {
        ...
        int result = 0;
        OutPt startOp = op;
			Single ptx = pt.X, pty = pt.Y;
			Single poly0x = op.Pt.X, poly0y = op.Pt.Y;
        do
        {
          op = op.Next;
				Single poly1x = op.Pt.X, poly1y = op.Pt.Y;
